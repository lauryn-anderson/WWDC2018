/*:
 ...
 > Here are some definitions in case you don't happen to be an English scholar: Noun = thing (dog, cake, bathtub) Plural noun = more than one thing (dogs, cakes, bathtubs) Adjective = describing word (fluffy, green, evil) Adverb = describing word that applies to verbs (quickly, violently, unknowingly). Hope that helps!
 ...
 will go through the array of words and mark the words you specify as blanks. It will return an array of these blanks. Your job this time is to decide how many nouns and adjectives will be blanked.
